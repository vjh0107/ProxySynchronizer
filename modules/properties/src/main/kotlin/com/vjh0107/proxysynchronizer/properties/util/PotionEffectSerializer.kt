package com.vjh0107.proxysynchronizer.properties.util
...
object PotionEffectSerializer : KSerializer<PotionEffect> {
    override val descriptor = PrimitiveSerialDescriptor("Bukkit.ProxySynchronizer.PotionEffectSerializer", PrimitiveKind.STRING)
